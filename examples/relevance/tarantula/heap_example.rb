...
describe Relevance::Tarantula::Heap do
  before(:each) do
    @heap = Relevance::Tarantula::MaxHeap.new
  end
  ...
  describe "(empty)" do
    ...
    it "should let you initialize with an array" do
      @heap = Relevance::Tarantula::MaxHeap.new([1,2,3])
  ...
  describe "(non-empty)" do
    before(:each) do
      ...
      @heap = Relevance::Tarantula::MaxHeap.new(@random_array)
    end
    ...
    it "should change certain keys" do
      ...
      heap = Relevance::Tarantula::MinHeap.new(numbers)
    ...
    it "should let you merge with another heap" do
      ...
      otherheap = Relevance::Tarantula::MaxHeap.new(numbers)
    ...
    describe "min-heap" do
      it "should be in min->max order" do
        @heap = Relevance::Tarantula::MinHeap.new(@random_array)
        ordered = []
        ordered << @heap.min! until @heap.empty?
